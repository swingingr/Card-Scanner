...
username = "swingingr"  # Your mysql username
password = "7GyHCJ87a5!"  # Your mysql password
...
def initializeDatabase():
    ...
    for x in range(evoSet.numCards):
        mycursor.execute("INSERT INTO EvolutionsSet (cardname) VALUES(%s)", (evoSet.cardnamelist[x],))
